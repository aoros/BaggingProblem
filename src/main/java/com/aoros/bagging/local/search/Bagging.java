...
public class Bagging {
    ...
    private static String filePath = "src/main/resources/g9";
    ...
    public static void main(String[] args) {
        ...
        startLocalSearch(filePath, timeLimitInSecs);
    }

    private static void startLocalSearch(String filePath, int timeLimitInSecs) {
